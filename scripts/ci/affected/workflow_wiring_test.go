...
func TestPlatformV2FocusedPolicyWiring(t *testing.T) {
	...
	for _, family := range []struct {
		...
		{"TestRuntimeStopAdapter_", "agentd", []string{"TestRuntimeStopAdapter_"}},
		{"TestOpenCodeStop", "agentd", []string{"TestOpenCodeStop"}},
		{"TestSoftExit_(SignalExitClearsJunkBufferOnFirstAttempt|SelectedPaneSwapSendsZeroBytesToSuccessor)", "agentd", []string{"TestSoftExit_SignalExitClearsJunkBufferOnFirstAttempt", "TestSoftExit_SelectedPaneSwapSendsZeroBytesToSuccessor"}},
		{"TestCopilotSoftExit_SignalExitClosesAnIdlePane", "agentd", []string{"TestCopilotSoftExit_SignalExitClosesAnIdlePane"}},
		{"TestReleaseAfterOpenCodeResumeProjection", "session", []string{"TestReleaseAfterOpenCodeResumeProjection"}},
		{"TestManagedOpenCodeLayerResumeRequiresProjectionDescriptors", "session", []string{"TestManagedOpenCodeLayerResumeRequiresProjectionDescriptors"}},
		{"TestOpenCodeProjectionDescriptorsRejectedOutsideSupportedResume", "session", []string{"TestOpenCodeProjectionDescriptorsRejectedOutsideSupportedResume"}},
