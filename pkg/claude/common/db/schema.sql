...
CREATE TABLE "sandbox_profiles" (
			...
			created_at       INTEGER NOT NULL,
			updated_at       INTEGER NOT NULL
		, includes_json TEXT NOT NULL DEFAULT '[]', agent_directories_json TEXT NOT NULL DEFAULT '[]', network_access TEXT NOT NULL DEFAULT '', network_json TEXT NOT NULL DEFAULT '', unix_sockets_json TEXT NOT NULL DEFAULT '', filesystem_spellings_json TEXT NOT NULL DEFAULT '', resource_limits_json TEXT NOT NULL DEFAULT '{}', darwin_allow_mach_register INTEGER NOT NULL DEFAULT 0 CHECK (darwin_allow_mach_register IN (0, 1)), darwin_disable_keychain_write INTEGER NOT NULL DEFAULT 0 CHECK (darwin_disable_keychain_write IN (0, 1)), pre_launch_json TEXT NOT NULL DEFAULT '[]', filesystem_root TEXT NOT NULL DEFAULT '', harness_config TEXT NOT NULL DEFAULT '', tmpfs_json TEXT NOT NULL DEFAULT '[]') STRICT;
...
CREATE TABLE "subscription_usage_windows" (
			...
			source           TEXT NOT NULL DEFAULT '', excluded INTEGER NOT NULL DEFAULT 0 CHECK(excluded IN (0, 1)), used_units REAL NOT NULL DEFAULT 0, limit_units REAL NOT NULL DEFAULT 0,
