...
CREATE TABLE sandbox_profiles (
			...
			created_at       TEXT NOT NULL,
			updated_at       TEXT NOT NULL
		, includes_json TEXT NOT NULL DEFAULT '[]', agent_directories_json TEXT NOT NULL DEFAULT '[]', network_access TEXT NOT NULL DEFAULT '', read_baseline TEXT NOT NULL DEFAULT '', break_glass_filesystem_json TEXT NOT NULL DEFAULT '[]', read_baseline_exclusions_json TEXT NOT NULL DEFAULT '[]');
