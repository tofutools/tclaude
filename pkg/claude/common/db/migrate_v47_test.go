...
// UpdateSessionModel / GetContextSnapshot accessors work end to end. The
// literal currentVersion pin (the tripwire) moved forward to
// migrate_v48_test.go with the v48 migration.
