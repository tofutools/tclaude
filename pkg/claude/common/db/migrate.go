...
func migrate(db *sql.DB) error {
	...
	if ver < 78 {
		if err := migrateV77toV78(db); err != nil {
			return err
		}
	}

	if ver < 79 {
		if err := migrateV78toV79(db); err != nil {
			return err
		}
	}

	if ver < 80 {
		if err := migrateV79toV80(db); err != nil {
			return err
		}
	}

	if ver < 81 {
		if err := migrateV80toV81(db); err != nil {
			return err
		}
	}

	if ver < 82 {
		if err := migrateV81toV82(db); err != nil {
			return err
		}
	}

	if ver < 83 {
		if err := migrateV82toV83(db); err != nil {
			return err
		}
	}

	if ver < 84 {
		if err := migrateV83toV84(db); err != nil {
			return err
		}
	}
	...
	if ver < 88 {
		if err := migrateV87toV88(db); err != nil {
			return err
		}
	}

	if ver < 89 {
		if err := migrateV88toV89(db); err != nil {
			return err
		}
	}

	if ver < 90 {
		if err := migrateV89toV90(db); err != nil {
			return err
		}
	}

	if ver < 91 {
		if err := migrateV90toV91(db); err != nil {
			return err
		}
	}

	if ver < 92 {
		if err := migrateV91toV92(db); err != nil {
			return err
		}
	}

	if ver < 93 {
		if err := migrateV92toV93(db); err != nil {
			return err
		}
	}

	if ver < 94 {
		if err := migrateV93toV94(db); err != nil {
			return err
		}
	}

	if ver < 95 {
		if err := migrateV94toV95(db); err != nil {
			return err
		}
	}
