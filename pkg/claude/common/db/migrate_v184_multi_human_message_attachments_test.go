...
func TestMigrateV183toV184_MatchesFreshSchema(t *testing.T) {
	d := v183FixtureDB(t)
	require.NoError(t, migrateV183toV184(d))
	require.NoError(t, migrateV184toV185(d))
	require.NoError(t, migrateV185toV186(d))
	require.NoError(t, migrateV186toV187(d))
	require.NoError(t, migrateV187toV188(d))
	require.NoError(t, migrateV188toV189(d))
	require.NoError(t, migrateV189toV190(d))
	require.NoError(t, migrateV190toV191(d))
	...
	require.NoError(t, migrateV197toV198(d))
	...
	require.NoError(t, migrateV226toV227(d))
