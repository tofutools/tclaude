...
// chain and asserts it lands at currentVersion. v99 is head, so the literal
// currentVersion tripwire lives here now (moved forward from v98).
func TestMigrateV98toV99_FreshSchema(t *testing.T) {
	...
	require.Equal(t, 99, currentVersion, "tripwire: bump this and add a v99→v100 test when you add a migration")
}
