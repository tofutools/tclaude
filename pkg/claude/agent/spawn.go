...
type SpawnParams struct {
	...
	TaskLabel string `long:"task-label" optional:"true" help:"Optional display label overriding the auto-derived one for --task (Linear/AWB->issue id, GitHub->repo/#nnn, else host)"`
