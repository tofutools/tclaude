...
type taskSetParams struct {
	...
	Label    string `long:"label" short:"l" optional:"true" help:"Optional display label overriding the auto-derived one (Linear/AWB->issue id, GitHub->repo/#nnn, else host)"`
