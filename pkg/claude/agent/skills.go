...
//
//go:embed skills/agent-coord/SKILL.md skills/agent-rename/SKILL.md skills/agent-lifecycle/SKILL.md skills/agent-schedule/SKILL.md skills/agent-dir/SKILL.md
