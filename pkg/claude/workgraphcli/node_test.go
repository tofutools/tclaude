...
// TestRunNode_ForbiddenMapsRCAuth pins the workgraph-local error refinement: the
...
func TestRunNode_StartShape(t *testing.T) {
	...
	if path != "PATCH /v1/workgraphs/4/nodes/impl" {
...
func TestRunSpawn_ContextShape(t *testing.T) {
	...
	if path != "POST /v1/workgraphs/4/nodes/work/start" {
...
func TestRunDrive_Shape(t *testing.T) {
	...
	if path != "POST /v1/workgraphs/7/drive" {
...
func TestRunCancel(t *testing.T) {
	...
	if path != "POST /v1/workgraphs/8/cancel" {
...
func TestRunRm(t *testing.T) {
	...
	if path != "DELETE /v1/workgraphs/8" {
