...
func TestRunLs_RendersInstancesAndTemplates(t *testing.T) {
	...
	if path != "GET /v1/workgraphs" {
		t.Errorf("ls hit %q, want GET /v1/workgraphs", path)
	}
	s := out.String()
...
func TestRunLs_JSON(t *testing.T) {
	...
	var got struct {
		...
		Templates []workgraph.ListEntry `json:"templates"`
	}
...
func TestRunStatus_Renders(t *testing.T) {
	...
	if path != "GET /v1/workgraphs/3" {
		t.Errorf("status hit %q, want GET /v1/workgraphs/3", path)
	}
	s := out.String()
...
func TestRunStatus_NotFoundMapsRC(t *testing.T) {
	daemonStub(t, nil, func(_, _ string, _ any) (any, error) {
		return nil, &agent.DaemonError{Status: 404, Code: "not_found", Msg: "workgraph 9 not found"}
	})
	var out, errBuf bytes.Buffer
...
func TestRunEvents_NodeFilterPath(t *testing.T) {
	...
	if path != "GET /v1/workgraphs/5/events?node=plan" {
...
func TestRunEvents_NoNodeNoQuery(t *testing.T) {
	...
	if path != "GET /v1/workgraphs/5/events" {
...
func TestRunWhere_DefaultLiveOnly(t *testing.T) {
	...
	if path != "GET /v1/workgraphs/where" {
...
func TestRunWhere_AllAndInstanceFilter(t *testing.T) {
	...
	if path != "GET /v1/workgraphs/where?instance=2" {
