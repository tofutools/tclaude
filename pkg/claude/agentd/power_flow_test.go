...
func TestPowerOn_GroupScope_ResumesOfflineSkipsOnline(t *testing.T) {
	...
	f.HaveAliveSession(offlineConv, "spwn-pogo", "tmux-pogo", "/tmp/pogo")
...
func TestPowerOn_AllScope_HitsGroupedAndUngrouped(t *testing.T) {
	...
	f.HaveAliveSession(groupedConv, "spwn-poag", "tmux-poag", "/tmp/poag")
	f.HaveAliveSession(looseConv, "spwn-poal", "tmux-poal", "/tmp/poal")
