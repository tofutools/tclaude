...
function MemberMenu({ member, group, snapshot, actions, ungrouped }) {
  ...
  return html`
    ...
    <${MenuButton} member=${member} act="debug-export" regular="export debug info" wizard="inscribe ward diagnostics" title=${wizardCopy('Download the recorded spawn parameters, current launch configuration, and exact composed sandbox policy. Task text and authorization tokens are redacted.', 'Download this familiar\'s recorded summoning parameters and exact composed wards. Quest text and authorization runes are redacted.')} />
    <${MenuSeparator} />
