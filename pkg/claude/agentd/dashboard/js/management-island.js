...
const NETWORK_ACCESS_HELP = 'Choose Allow or Deny independently for built-in packs and manual '
  ...
  + 'class. Host and domain rules allow IP addresses returned by DNS. The sandbox can also reach '
  + 'other sites hosted on that same IP until the DNS answer expires. Only a new DNS lookup '
