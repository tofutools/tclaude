...
const NETWORK_ACCESS_HELP = 'Choose Allow or Deny independently for built-in packs and manual '
  ...
  + 'effective provider endpoint is not launch-resolvable; that seam is tracked in TCL-826. On Linux, '
