...
const NETWORK_ACCESS_HELP = 'List rows describe outbound destinations. Host matches one exact DNS '
  ...
  + 'ordinary IPv4/IPv6 TCP and UDP; QUIC is UDP. ICMP echo is best-effort for portless rows. Raw '
  + 'and packet sockets are not an authored class. Applied global, group, and explicit list '
