...
function GroupMenuItems({ group, members, snapshot, actions }) {
  ...
  return html`
    ...
    <${MenuButton} title="Set group overrides for which harnesses may spawn agents on other harnesses" regular="⇄ cross-harness spawns…" wizard="⇄ cross-realm summons…" onClick=${() => actions.openSpawnHarnessPolicy(group)} />
