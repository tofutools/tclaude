...
function GroupMenuItems({ group, members, snapshot, actions }) {
  ...
  return html`
    ...
    <${MenuButton} ...${shared} data-act="pull-repositories-group" title="Git pull — update this home repository with a fast-forward pull" regular="↓ pull repository…" wizard="↓ summon latest code…" />
    <${MenuButton} ...${shared} data-act="sync-repositories-group" title="Git sync — fetch, prune stale remote references, then fast-forward pull" regular="↻ sync repository…" wizard="✧ harmonize repository…" />
