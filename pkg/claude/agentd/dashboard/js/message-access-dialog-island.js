  ...
  return html`<${Overlay} id="perm-edit-modal" dialogClass="perm-edit-modal" labelledby="perm-edit-title"
    ...
    ${groupMode && html`<div class="perm-edit-owner-scopes" id="perm-edit-owner-scopes">
      <label for="perm-edit-owner-scopes-input"><${Words}
        ...
        wizard=${html`👑 <strong>Bind the crown</strong> — adds constraints to the boons granted by wearing this party's crown, e.g. <code>{"groups.members.spawn": {"spawn_profile": ["reviewer"], "sandbox_profile": ["locked-down"]}}</code>. Empty = unbound. Other boons are untouched.`}/></label>
