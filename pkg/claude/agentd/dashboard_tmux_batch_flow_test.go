...
func TestDashboardSnapshot_OneTmuxListZeroHasSession(t *testing.T) {
	...
	f.HaveAliveSession(c1, "spwn-1", "tmux-1", f.TestCwd("c1"))
	f.HaveAliveSession(c2, "spwn-2", "tmux-2", f.TestCwd("c2"))
	f.HaveAliveSession(c3, "spwn-3", "tmux-3", f.TestCwd("c3"))
	f.HaveAliveSession(c4, "spwn-4", "tmux-4", f.TestCwd("c4"))
