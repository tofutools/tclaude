...
func TestDashboardHTMLSpawnHarnessPolicyUI(t *testing.T) {
	for needle, why := range map[string]string{
		...
		`cross-harness spawns…`:                           "global and group menu label",
		...
		`Reason returned to the spawning agent`:           "denial reason input",
		`<option value="inherit">inherit global</option>`: "group inheritance choice",
	} {
