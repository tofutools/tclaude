...
func TestDashboardAgentSpawnPreactOwnership(t *testing.T) {
	...
	present("resizeKey=\"tclaude.dash.modalSize.agent-spawn\"", "component preserves modal width")
	present("persistHeight=${false}", "component lets its contents recalculate modal height")
