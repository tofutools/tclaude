...
func TestDeriveTaskLabel(t *testing.T) {
	cases := []struct {
		...
		{"awb https", "https://www.staldal.nu/awb/#/issues/tcl-536325", "tcl-536325"},
		{"awb http arbitrary host and base path", "http://awb.example.test/a/b/#/issues/ops-a3f9c1", "ops-a3f9c1"},
		{"awb trailing slash", "https://example.test/#/issues/tcl-42/", "tcl-42"},
		{"awb route query omitted", "https://example.test/#/issues/tcl-42?tab=comments", "tcl-42"},
		{"awb missing id", "https://example.test/#/issues", "example.test"},
		{"awb deeper route is not an issue route", "https://example.test/#/issues/tcl-42/comments", "example.test"},
		{"awb invalid id", "https://example.test/#/issues/not-an-awb-id", "example.test"},
		{"github issue", "https://github.com/tofutools/tclaude/issues/42", "#42"},
		{"github label outranks awb-like fragment", "https://github.com/tofutools/tclaude/issues/42#/issues/tcl-9", "#42"},
		{"github pull", "https://github.com/tofutools/tclaude/pull/7", "#7"},
		{"github repository", "https://github.com/GiGurra/brain", "gh:GiGurra/brain"},
		{"github repository trailing slash", "https://github.com/foo/bar/", "gh:foo/bar"},
		{"github repository query and fragment", "https://github.com/foo/bar?tab=readme-ov-file#readme", "gh:foo/bar"},
		{"github www repository", "https://www.github.com/foo/bar", "gh:foo/bar"},
		{"github home", "https://github.com", "github.com"},
		{"github owner", "https://github.com/foo", "github.com"},
		{"github lookalike host", "https://github.com.example.com/foo/bar", "github.com.example.com"},
