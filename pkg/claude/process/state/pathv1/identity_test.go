...
func TestPublishedGoldenVectors(t *testing.T) {
	...
	commands := []struct {
		...
		{"command_sink", "fba1b0270615b03d7ee5e520fa2b0008cfecfa86b5f332d5f49039acc6417ba4", CommandIdentity{RunID: "run-7", Kind: CommandSettleDetachedSink, PayloadSchema: 1, SourcePathID: "loser-p", TargetReservationID: "res-b", TargetGeneration: 1, InputDigest: "detachset-d", CauseDigest: "cause-d", ResultCode: "detached"}},
