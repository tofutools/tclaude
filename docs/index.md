...
- 🤝 **Agent Coordination** - Cross-session messaging and permission-gated self-service via `tclaude agent` + `agentd` (experimental)
...
- [Agent Coordination](agent.md) - Cross-session messaging and self-service via `tclaude agent` + `agentd` (**experimental**)
