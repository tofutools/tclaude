...
terminals you have viewed. A link to an agent whose terminal can no longer be
attached falls back to the Groups tab rather than leaving you on an empty tab.
