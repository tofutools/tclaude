...
func TestImportCopilotNativeApprovalPreservesProfileAndAgentBirthPolicy(t *testing.T) {
 ...
 VALUES('7','Copilot native','[]','[]','[]','copilot','fixture','/tmp','deny','unconfined');
 UPDATE agents SET initial_spawn_config='{"harness":"copilot","model":"fixture","working_directory":"/tmp","approval":"deny","sandbox":"unconfined"}';
 `, "deny", string(mode)))
			...
			require.Equal(t, "copilot", snapshot.Agents[0].Desired.Harness)
