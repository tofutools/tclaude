...
var RequiredTables = map[string]TableSpec{
	...
	"spawn_profiles":                  {Columns: []string{"id", "name", "permission_overrides", "environment_json", "role_refs", "disabled", "disabled_reason", "fast_mode", "auto_review", "operator_only"}, Key: []string{"id"}},
