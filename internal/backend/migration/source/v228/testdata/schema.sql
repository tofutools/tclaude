...
CREATE TABLE logical_conversations (
 id TEXT PRIMARY KEY, created_at INTEGER NOT NULL
) STRICT;

CREATE TABLE conversation_attempt_bindings (
...
CREATE INDEX conversation_attempt_session ON conversation_attempt_bindings(session_id);

CREATE TABLE conversation_reference_bindings (
