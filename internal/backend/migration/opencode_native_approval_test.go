...
func TestImportOpenCodeNativeApprovalPreservesProfileAndAgentBirthPolicy(t *testing.T) {
	for _, mode := range []model.ApprovalMode{model.ApprovalAsk, model.ApprovalAllowTools} {
 ...
 VALUES('7','OpenCode native','[]','[]','[]','opencode','fixture','/tmp','deny','unconfined');
