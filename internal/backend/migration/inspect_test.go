...
func insertFixtureRows(t *testing.T, db *sql.DB, options fixtureOptions) {
	...
	exec(`INSERT INTO conversation_attempt_bindings(execution_id,conversation_id,external_ref,revision) VALUES('exe_fixture','cvn_fixture','native-conv','1')`)
	exec(`INSERT INTO conversation_reference_bindings(execution_id,revision,conversation_id,external_ref) VALUES('exe_fixture','1','cvn_fixture','native-conv')`)
