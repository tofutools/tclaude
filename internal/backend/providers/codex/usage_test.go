...
{"timestamp":"2026-09-07T01:02:00Z","type":"event_msg","payload":{"type":"token_count","info":{"total_token_usage":{"input_tokens":250,"cached_input_tokens":90,"output_tokens":55,"reasoning_output_tokens":8,"total_tokens":305}}}}`)
	...
	require.Equal(t, []model.UsageCounter{
		...
		{Unit: model.UsageCacheReadTokens, Value: 90}, {Unit: model.UsageReasoningTokens, Value: 8},
	}, counters)
}
