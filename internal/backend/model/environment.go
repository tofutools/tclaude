...
func (d DesiredConfiguration) Equal(other DesiredConfiguration) bool {
	return SameSandboxSelection(d.HostSandbox, other.HostSandbox) && d.Harness == other.Harness && d.Model == other.Model && d.Effort == other.Effort && d.AutoReview == other.AutoReview && d.AutoMemory == other.AutoMemory && d.PeerMessaging == other.PeerMessaging && d.TrustDirectory == other.TrustDirectory && d.AutoCompactWindow == other.AutoCompactWindow && d.FastMode == other.FastMode && d.ToolGovernance == other.ToolGovernance && d.WorkingDirectory == other.WorkingDirectory && d.Approval == other.Approval && d.Sandbox == other.Sandbox && d.Environment.Equal(other.Environment)
}
