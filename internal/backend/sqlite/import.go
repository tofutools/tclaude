...
func (s *Store) verifyImportCounts(ctx context.Context, batch app.ImportBatch) error {
	...
	for _, table := range []string{
		...
		"configuration_profile_requests", "configuration_profile_lifecycle_requests", "automation_state_requests", "automation_archive_requests", "access_requests", "access_request_decisions", "message_notifications", "presentation_preferences", "terminal_files",
