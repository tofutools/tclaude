...
document.addEventListener('group-order-changed',()=>{renderGroupControls(snapshot,{host:$('group-management'),el,button,edit,api,refresh,presentation,attach});rosterWorkspace.update(snapshot,agentRow,presentation.prefs.GroupOrder||[])});
...
function render(){
 ...
 renderGroupControls(snapshot,{host:$('group-management'),el,button,edit,api,refresh,presentation,attach});
