...
func TestBrowserConfigurationTransferPreviewsRenamesAndRetries(t *testing.T) {
	...
	require.NoError(t, operator.Call(ctx, "POST", "/v2/configuration-profiles", map[string]any{"request_id": "original", "id": "original", "revision_id": "one", "name": "Original", "desired": desired}, nil))
